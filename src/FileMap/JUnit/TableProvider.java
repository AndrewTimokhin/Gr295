...
public interface TableProvider {
     ...
     * @param name
     *            Название таблицы.
     * @return Объект, представляющий таблицу. Если таблицы с указанным именем
     *         не существует, возвращает null.
     ...
     * @param name
     *            Название таблицы.
     * @return Объект, представляющий таблицу. Если таблица уже существует,
     *         возвращает null.
     * @throws IllegalArgumentException
     *             Если название таблицы null или имеет недопустимое значение.
     */
